...
// ActionsServiceInterface defines the interface for the ActionsService for easy testing.
//
...
type ActionsServiceInterface interface {
	...
	AddRunerGroupRunners(ctx context.Context, org string, groupID, runnerID int64) (*github.Response, error)
	...
	CancelWorkflowRunByID(ctx context.Context, owner, repo string, runID int64) (*github.Response, error)
	...
	CreateRemoveToken(ctx context.Context, owner, repo string) (*github.RemoveToken, *github.Response, error)
	...
	DeleteArtifact(ctx context.Context, owner, repo string, artifactID int64) (*github.Response, error)
	...
	DeleteEnvSecret(ctx context.Context, repoID int, env, secretName string) (*github.Response, error)
	...
	DeleteWorkflowRunLogs(ctx context.Context, owner, repo string, runID int64) (*github.Response, error)
	...
	DisableWorkflowByFileName(ctx context.Context, owner, repo, workflowFileName string) (*github.Response, error)

	// DisableWorkflowByID disables a workflow and sets the state of the workflow to "disabled_manually".
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/actions/#disable-a-workflow
	DisableWorkflowByID(ctx context.Context, owner, repo string, workflowID int64) (*github.Response, error)
	...
	DownloadArtifact(ctx context.Context, owner, repo string, artifactID int64, followRedirects bool) (*url.URL, *github.Response, error)
	...
	EnableWorkflowByFileName(ctx context.Context, owner, repo, workflowFileName string) (*github.Response, error)

	// EnableWorkflowByID enables a workflow and sets the state of the workflow to "active".
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/actions/#enable-a-workflow
	EnableWorkflowByID(ctx context.Context, owner, repo string, workflowID int64) (*github.Response, error)
	...
	GetRunner(ctx context.Context, owner, repo string, runnerID int64) (*github.Runner, *github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/actions/#get-a-workflow
	GetWorkflowByID(ctx context.Context, owner, repo string, workflowID int64) (*github.Workflow, *github.Response, error)
	...
	GetWorkflowJobLogs(ctx context.Context, owner, repo string, jobID int64, followRedirects bool) (*url.URL, *github.Response, error)
	...
	GetWorkflowRunLogs(ctx context.Context, owner, repo string, runID int64, followRedirects bool) (*url.URL, *github.Response, error)
	...
	GetWorkflowUsageByFileName(ctx context.Context, owner, repo, workflowFileName string) (*github.WorkflowUsage, *github.Response, error)
	...
	ListArtifacts(ctx context.Context, owner, repo string, opts *github.ListOptions) (*github.ArtifactList, *github.Response, error)
	...
	ListRepositoryAccessRunnerGroup(ctx context.Context, org string, groupID int64) (*github.ListRepositories, *github.Response, error)
	...
	ListRunerGroupRunners(ctx context.Context, org string, groupID int64, opts *github.ListOptions) (*github.Runners, *github.Response, error)
	...
	ListSelectedReposForOrgSecret(ctx context.Context, org, name string) (*github.SelectedReposList, *github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/actions/#list-workflow-runs
	ListWorkflowRunsByID(ctx context.Context, owner, repo string, workflowID int64, opts *github.ListWorkflowRunsOptions) (*github.WorkflowRuns, *github.Response, error)
	...
	RemoveRunerGroupRunners(ctx context.Context, org string, groupID, runnerID int64) (*github.Response, error)
	...
	SetRunerGroupRunners(ctx context.Context, org string, groupID int64, ids github.SetRunnerGroupRunnersRequest) (*github.Response, error)
...
// ActivityServiceInterface defines the interface for the ActivityService for easy testing.
//
...
type ActivityServiceInterface interface {
	...
	DeleteRepositorySubscription(ctx context.Context, owner, repo string) (*github.Response, error)
	...
	GetRepositorySubscription(ctx context.Context, owner, repo string) (*github.Subscription, *github.Response, error)
	...
	IsStarred(ctx context.Context, owner, repo string) (bool, *github.Response, error)
	...
	ListEventsForRepoNetwork(ctx context.Context, owner, repo string, opts *github.ListOptions) ([]*github.Event, *github.Response, error)
	...
	ListIssueEventsForRepository(ctx context.Context, owner, repo string, opts *github.ListOptions) ([]*github.IssueEvent, *github.Response, error)
	...
	ListRepositoryNotifications(ctx context.Context, owner, repo string, opts *github.NotificationListOptions) ([]*github.Notification, *github.Response, error)

	// ListStargazers lists people who have starred the specified repo.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/activity/#list-stargazers
	ListStargazers(ctx context.Context, owner, repo string, opts *github.ListOptions) ([]*github.Stargazer, *github.Response, error)
	...
	ListUserEventsForOrganization(ctx context.Context, org, user string, opts *github.ListOptions) ([]*github.Event, *github.Response, error)
	...
	ListWatchers(ctx context.Context, owner, repo string, opts *github.ListOptions) ([]*github.User, *github.Response, error)
	...
	MarkRepositoryNotificationsRead(ctx context.Context, owner, repo string, lastRead time.Time) (*github.Response, error)
	...
	SetRepositorySubscription(ctx context.Context, owner, repo string, subscription *github.Subscription) (*github.Subscription, *github.Response, error)
	...
	Star(ctx context.Context, owner, repo string) (*github.Response, error)
	...
	Unstar(ctx context.Context, owner, repo string) (*github.Response, error)
}

// ActivityService implements the ActivityServiceInterface.
var _ ActivityServiceInterface = &github.ActivityService{}

// AdminServiceInterface defines the interface for the AdminService for easy testing.
//
...
type AdminServiceInterface interface {
	...
	CreateUser(ctx context.Context, login, email string) (*github.User, *github.Response, error)
	...
	//
	// GitHub Enterprise API docs: https://developer.github.com/enterprise/v3/enterprise-admin/orgs/#rename-an-organization
	RenameOrgByName(ctx context.Context, org, newName string) (*github.RenameOrgResponse, *github.Response, error)
...
// AppsServiceInterface defines the interface for the AppsService for easy testing.
//
...
type AppsServiceInterface interface {
	...
	AddRepository(ctx context.Context, instID, repoID int64) (*github.Repository, *github.Response, error)
	...
	CreateAttachment(ctx context.Context, contentReferenceID int64, title, body string) (*github.Attachment, *github.Response, error)
	...
	RemoveRepository(ctx context.Context, instID, repoID int64) (*github.Response, error)
...
// AuthorizationsServiceInterface defines the interface for the AuthorizationsService for easy testing.
//
...
type AuthorizationsServiceInterface interface {
	...
	Check(ctx context.Context, clientID, accessToken string) (*github.Authorization, *github.Response, error)
	...
	DeleteGrant(ctx context.Context, clientID, accessToken string) (*github.Response, error)
	...
	Reset(ctx context.Context, clientID, accessToken string) (*github.Authorization, *github.Response, error)
	...
	Revoke(ctx context.Context, clientID, accessToken string) (*github.Response, error)
}
...
// BillingServiceInterface defines the interface for the BillingService for easy testing.
//
...
// ChecksServiceInterface defines the interface for the ChecksService for easy testing.
//
...
type ChecksServiceInterface interface {
	...
	CreateCheckSuite(ctx context.Context, owner, repo string, opts github.CreateCheckSuiteOptions) (*github.CheckSuite, *github.Response, error)
	...
	GetCheckSuite(ctx context.Context, owner, repo string, checkSuiteID int64) (*github.CheckSuite, *github.Response, error)
	...
	ListCheckRunsCheckSuite(ctx context.Context, owner, repo string, checkSuiteID int64, opts *github.ListCheckRunsOptions) (*github.ListCheckRunsResults, *github.Response, error)
	...
	ReRequestCheckSuite(ctx context.Context, owner, repo string, checkSuiteID int64) (*github.Response, error)
	...
	SetCheckSuitePreferences(ctx context.Context, owner, repo string, opts github.CheckSuitePreferenceOptions) (*github.CheckSuitePreferenceResults, *github.Response, error)
...
// CodeScanningServiceInterface defines the interface for the CodeScanningService for easy testing.
//
...
type CodeScanningServiceInterface interface {
	...
	GetAlert(ctx context.Context, owner, repo string, id int64) (*github.Alert, *github.Response, error)
...
// EnterpriseServiceInterface defines the interface for the EnterpriseService for easy testing.
//
...
// GistsServiceInterface defines the interface for the GistsService for easy testing.
//
...
type GistsServiceInterface interface {
	...
	GetRevision(ctx context.Context, id, sha string) (*github.Gist, *github.Response, error)
...
// GitServiceInterface defines the interface for the GitService for easy testing.
//
...
// GitignoresServiceInterface defines the interface for the GitignoresService for easy testing.
//
...
// InteractionsServiceInterface defines the interface for the InteractionsService for easy testing.
//
...
type InteractionsServiceInterface interface {
	...
	RemoveRestrictionsFromRepo(ctx context.Context, owner, repo string) (*github.Response, error)
...
// IssueImportServiceInterface defines the interface for the IssueImportService for easy testing.
//
...
type IssueImportServiceInterface interface {
	...
	CheckStatus(ctx context.Context, owner, repo string, issueID int64) (*github.IssueImportResponse, *github.Response, error)
	...
	CheckStatusSince(ctx context.Context, owner, repo string, since time.Time) ([]*github.IssueImportResponse, *github.Response, error)
	...
	Create(ctx context.Context, owner, repo string, issue *github.IssueImportRequest) (*github.IssueImportResponse, *github.Response, error)
}

// IssueImportService implements the IssueImportServiceInterface.
var _ IssueImportServiceInterface = &github.IssueImportService{}

// IssuesServiceInterface defines the interface for the IssuesService for easy testing.
//
...
type IssuesServiceInterface interface {
	...
	GetEvent(ctx context.Context, owner, repo string, id int64) (*github.IssueEvent, *github.Response, error)
	...
	IsAssignee(ctx context.Context, owner, repo, user string) (bool, *github.Response, error)
	...
	ListAssignees(ctx context.Context, owner, repo string, opts *github.ListOptions) ([]*github.User, *github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/issues/#list-issue-events-for-a-repository
	ListRepositoryEvents(ctx context.Context, owner, repo string, opts *github.ListOptions) ([]*github.IssueEvent, *github.Response, error)
...
// LicensesServiceInterface defines the interface for the LicensesService for easy testing.
//
...
// MarketplaceServiceInterface defines the interface for the MarketplaceService for easy testing.
//
...
// MigrationServiceInterface defines the interface for the MigrationService for easy testing.
//
...
type MigrationServiceInterface interface {
	...
	CancelImport(ctx context.Context, owner, repo string) (*github.Response, error)
	...
	CommitAuthors(ctx context.Context, owner, repo string) ([]*github.SourceImportAuthor, *github.Response, error)
	...
	DeleteMigration(ctx context.Context, org string, id int64) (*github.Response, error)
	...
	DeleteUserMigration(ctx context.Context, id int64) (*github.Response, error)
	...
	ImportProgress(ctx context.Context, owner, repo string) (*github.Import, *github.Response, error)

	// LargeFiles lists files larger than 100MB found during the import.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/migrations/#get-large-files
	LargeFiles(ctx context.Context, owner, repo string) ([]*github.LargeFile, *github.Response, error)
	...
	ListMigrations(ctx context.Context, org string, opts *github.ListOptions) ([]*github.Migration, *github.Response, error)
	...
	ListUserMigrations(ctx context.Context) ([]*github.UserMigration, *github.Response, error)
	...
	MapCommitAuthor(ctx context.Context, owner, repo string, id int64, author *github.SourceImportAuthor) (*github.SourceImportAuthor, *github.Response, error)
	...
	SetLFSPreference(ctx context.Context, owner, repo string, in *github.Import) (*github.Import, *github.Response, error)
	...
	StartUserMigration(ctx context.Context, repos []string, opts *github.UserMigrationOptions) (*github.UserMigration, *github.Response, error)
	...
	UnlockRepo(ctx context.Context, org string, id int64, repo string) (*github.Response, error)
	...
	UnlockUserRepo(ctx context.Context, id int64, repo string) (*github.Response, error)

	// UpdateImport initiates a repository import.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/migrations/#update-an-import
	UpdateImport(ctx context.Context, owner, repo string, in *github.Import) (*github.Import, *github.Response, error)
	...
	UserMigrationStatus(ctx context.Context, id int64) (*github.UserMigration, *github.Response, error)
}

// MigrationService implements the MigrationServiceInterface.
var _ MigrationServiceInterface = &github.MigrationService{}

// OrganizationsServiceInterface defines the interface for the OrganizationsService for easy testing.
//
...
type OrganizationsServiceInterface interface {
	...
	ConcealMembership(ctx context.Context, org, user string) (*github.Response, error)
	...
	IsPublicMember(ctx context.Context, org, user string) (bool, *github.Response, error)
	...
	ListOrgInvitationTeams(ctx context.Context, org, invitationID string, opts *github.ListOptions) ([]*github.Team, *github.Response, error)
	...
	PublicizeMembership(ctx context.Context, org, user string) (*github.Response, error)
...
// ProjectsServiceInterface defines the interface for the ProjectsService for easy testing.
//
...
// PullRequestsServiceInterface defines the interface for the PullRequestsService for easy testing.
//
...
type PullRequestsServiceInterface interface {
	...
	EditComment(ctx context.Context, owner, repo string, commentID int64, comment *github.PullRequestComment) (*github.PullRequestComment, *github.Response, error)
...
// ReactionsServiceInterface defines the interface for the ReactionsService for easy testing.
//
...
type ReactionsServiceInterface interface {
	...
	CreateCommentReaction(ctx context.Context, owner, repo string, id int64, content string) (*github.Reaction, *github.Response, error)
	...
	CreateIssueReaction(ctx context.Context, owner, repo string, number int, content string) (*github.Reaction, *github.Response, error)
	...
	CreateTeamDiscussionCommentReaction(ctx context.Context, teamID int64, discussionNumber, commentNumber int, content string) (*github.Reaction, *github.Response, error)
	...
	DeleteCommentReaction(ctx context.Context, owner, repo string, commentID, reactionID int64) (*github.Response, error)

	// DeleteCommentReactionByID deletes the reaction for a commit comment by repository ID.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/reactions/#delete-a-commit-comment-reaction
	DeleteCommentReactionByID(ctx context.Context, repoID, commentID, reactionID int64) (*github.Response, error)
	...
	DeleteIssueCommentReaction(ctx context.Context, owner, repo string, commentID, reactionID int64) (*github.Response, error)

	// DeleteIssueCommentReactionByID deletes the reaction to an issue comment by repository ID.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/reactions/#delete-an-issue-comment-reaction
	DeleteIssueCommentReactionByID(ctx context.Context, repoID, commentID, reactionID int64) (*github.Response, error)
	...
	DeleteIssueReaction(ctx context.Context, owner, repo string, issueNumber int, reactionID int64) (*github.Response, error)

	// DeleteIssueReactionByID deletes the reaction to an issue by repository ID.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/reactions/#delete-an-issue-reaction
	DeleteIssueReactionByID(ctx context.Context, repoID, issueNumber int, reactionID int64) (*github.Response, error)
	...
	DeletePullRequestCommentReaction(ctx context.Context, owner, repo string, commentID, reactionID int64) (*github.Response, error)

	// DeletePullRequestCommentReactionByID deletes the reaction to a pull request review comment by repository ID.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/reactions/#delete-a-pull-request-comment-reaction
	DeletePullRequestCommentReactionByID(ctx context.Context, repoID, commentID, reactionID int64) (*github.Response, error)
	...
	DeleteTeamDiscussionCommentReaction(ctx context.Context, org, teamSlug string, discussionNumber, commentNumber int, reactionID int64) (*github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/reactions/#delete-team-discussion-comment-reaction
	DeleteTeamDiscussionCommentReactionByOrgIDAndTeamID(ctx context.Context, orgID, teamID, discussionNumber, commentNumber int, reactionID int64) (*github.Response, error)
	...
	DeleteTeamDiscussionReaction(ctx context.Context, org, teamSlug string, discussionNumber int, reactionID int64) (*github.Response, error)

	// DeleteTeamDiscussionReactionByOrgIDAndTeamID deletes the reaction to a team discussion by organization ID and team ID.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/reactions/#delete-team-discussion-reaction
	DeleteTeamDiscussionReactionByOrgIDAndTeamID(ctx context.Context, orgID, teamID, discussionNumber int, reactionID int64) (*github.Response, error)
	...
	ListCommentReactions(ctx context.Context, owner, repo string, id int64, opts *github.ListCommentReactionOptions) ([]*github.Reaction, *github.Response, error)
	...
	ListPullRequestCommentReactions(ctx context.Context, owner, repo string, id int64, opts *github.ListOptions) ([]*github.Reaction, *github.Response, error)
	...
	ListTeamDiscussionCommentReactions(ctx context.Context, teamID int64, discussionNumber, commentNumber int, opts *github.ListOptions) ([]*github.Reaction, *github.Response, error)
...
// RepositoriesServiceInterface defines the interface for the RepositoriesService for easy testing.
//
...
type RepositoriesServiceInterface interface {
	...
	DeleteEnvironment(ctx context.Context, owner, repo, name string) (*github.Response, error)
	...
	// returned error is nil. Callers should check the returned Response status
	// code to verify the content is from a successful response.
	DownloadContentsWithMeta(ctx context.Context, owner, repo, filepath string, opts *github.RepositoryContentGetOptions) (io.ReadCloser, *github.RepositoryContent, *github.Response, error)
	...
	ListEnvironments(ctx context.Context, owner, repo string) (*github.EnvResponse, *github.Response, error)
	...
	RemoveRequiredStatusChecks(ctx context.Context, owner, repo, branch string) (*github.Response, error)
...
// SearchServiceInterface defines the interface for the SearchService for easy testing.
//
...
// TeamsServiceInterface defines the interface for the TeamsService for easy testing.
//
...
type TeamsServiceInterface interface {
	...
	AddTeamMembershipByID(ctx context.Context, orgID, teamID int64, user string, opts *github.TeamAddTeamMembershipOptions) (*github.Membership, *github.Response, error)
	...
	AddTeamProjectByID(ctx context.Context, orgID, teamID, projectID int64, opts *github.TeamProjectOptions) (*github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#add-or-update-team-project-permissions
	AddTeamProjectBySlug(ctx context.Context, org, slug string, projectID int64, opts *github.TeamProjectOptions) (*github.Response, error)
	...
	CreateCommentByID(ctx context.Context, orgID, teamID int64, discsusionNumber int, comment github.DiscussionComment) (*github.DiscussionComment, *github.Response, error)

	// CreateCommentBySlug creates a new comment on a team discussion by team slug.
	// Authenticated user must grant write:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#create-a-discussion-comment
	CreateCommentBySlug(ctx context.Context, org, slug string, discsusionNumber int, comment github.DiscussionComment) (*github.DiscussionComment, *github.Response, error)
	...
	CreateDiscussionByID(ctx context.Context, orgID, teamID int64, discussion github.TeamDiscussion) (*github.TeamDiscussion, *github.Response, error)

	// CreateDiscussionBySlug creates a new discussion post on a team's page given Organization name and Team's slug.
	// Authenticated user must grant write:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#create-a-discussion
	CreateDiscussionBySlug(ctx context.Context, org, slug string, discussion github.TeamDiscussion) (*github.TeamDiscussion, *github.Response, error)
	...
	CreateOrUpdateIDPGroupConnectionsByID(ctx context.Context, orgID, teamID int64, opts github.IDPGroupList) (*github.IDPGroupList, *github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#create-or-update-idp-group-connections
	CreateOrUpdateIDPGroupConnectionsBySlug(ctx context.Context, org, slug string, opts github.IDPGroupList) (*github.IDPGroupList, *github.Response, error)
	...
	DeleteCommentByID(ctx context.Context, orgID, teamID int64, discussionNumber, commentNumber int) (*github.Response, error)

	// DeleteCommentBySlug deletes a comment on a team discussion by team slug.
	// Authenticated user must grant write:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#delete-a-discussion-comment
	DeleteCommentBySlug(ctx context.Context, org, slug string, discussionNumber, commentNumber int) (*github.Response, error)
	...
	DeleteDiscussionByID(ctx context.Context, orgID, teamID int64, discussionNumber int) (*github.Response, error)

	// DeleteDiscussionBySlug deletes a discussion from team's page given Organization name and Team's slug.
	// Authenticated user must grant write:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#delete-a-discussion
	DeleteDiscussionBySlug(ctx context.Context, org, slug string, discussionNumber int) (*github.Response, error)
	...
	DeleteTeamByID(ctx context.Context, orgID, teamID int64) (*github.Response, error)
	...
	EditCommentByID(ctx context.Context, orgID, teamID int64, discussionNumber, commentNumber int, comment github.DiscussionComment) (*github.DiscussionComment, *github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#update-a-discussion-comment
	EditCommentBySlug(ctx context.Context, org, slug string, discussionNumber, commentNumber int, comment github.DiscussionComment) (*github.DiscussionComment, *github.Response, error)
	...
	EditDiscussionByID(ctx context.Context, orgID, teamID int64, discussionNumber int, discussion github.TeamDiscussion) (*github.TeamDiscussion, *github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#update-a-discussion
	EditDiscussionBySlug(ctx context.Context, org, slug string, discussionNumber int, discussion github.TeamDiscussion) (*github.TeamDiscussion, *github.Response, error)
	...
	GetCommentByID(ctx context.Context, orgID, teamID int64, discussionNumber, commentNumber int) (*github.DiscussionComment, *github.Response, error)

	// GetCommentBySlug gets a specific comment on a team discussion by team slug.
	// Authenticated user must grant read:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#get-a-discussion-comment
	GetCommentBySlug(ctx context.Context, org, slug string, discussionNumber, commentNumber int) (*github.DiscussionComment, *github.Response, error)
	...
	GetDiscussionByID(ctx context.Context, orgID, teamID int64, discussionNumber int) (*github.TeamDiscussion, *github.Response, error)

	// GetDiscussionBySlug gets a specific discussion on a team's page given Organization name and Team's slug.
	// Authenticated user must grant read:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#get-a-discussion
	GetDiscussionBySlug(ctx context.Context, org, slug string, discussionNumber int) (*github.TeamDiscussion, *github.Response, error)
	...
	GetTeamMembershipByID(ctx context.Context, orgID, teamID int64, user string) (*github.Membership, *github.Response, error)
	...
	IsTeamRepoByID(ctx context.Context, orgID, teamID int64, owner, repo string) (*github.Repository, *github.Response, error)
	...
	ListChildTeamsByParentID(ctx context.Context, orgID, teamID int64, opts *github.ListOptions) ([]*github.Team, *github.Response, error)
	...
	ListCommentsByID(ctx context.Context, orgID, teamID int64, discussionNumber int, options *github.DiscussionCommentListOptions) ([]*github.DiscussionComment, *github.Response, error)

	// ListCommentsBySlug lists all comments on a team discussion by team slug.
	// Authenticated user must grant read:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#list-discussion-comments
	ListCommentsBySlug(ctx context.Context, org, slug string, discussionNumber int, options *github.DiscussionCommentListOptions) ([]*github.DiscussionComment, *github.Response, error)
	...
	ListDiscussionsByID(ctx context.Context, orgID, teamID int64, opts *github.DiscussionListOptions) ([]*github.TeamDiscussion, *github.Response, error)

	// ListDiscussionsBySlug lists all discussions on team's page given Organization name and Team's slug.
	// Authenticated user must grant read:discussion scope.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#list-discussions
	ListDiscussionsBySlug(ctx context.Context, org, slug string, opts *github.DiscussionListOptions) ([]*github.TeamDiscussion, *github.Response, error)
	...
	ListIDPGroupsForTeamByID(ctx context.Context, orgID, teamID int64) (*github.IDPGroupList, *github.Response, error)

	// ListIDPGroupsForTeamBySlug lists IDP groups connected to a team on GitHub
	// given organization name and team slug.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#list-idp-groups-for-a-team
	ListIDPGroupsForTeamBySlug(ctx context.Context, org, slug string) (*github.IDPGroupList, *github.Response, error)
	...
	ListPendingTeamInvitationsByID(ctx context.Context, orgID, teamID int64, opts *github.ListOptions) ([]*github.Invitation, *github.Response, error)
	...
	ListTeamProjectsByID(ctx context.Context, orgID, teamID int64) ([]*github.Project, *github.Response, error)

	// ListTeamProjectsBySlug lists the organization projects for a team given the team slug.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#list-team-projects
	ListTeamProjectsBySlug(ctx context.Context, org, slug string) ([]*github.Project, *github.Response, error)
	...
	RemoveTeamMembershipByID(ctx context.Context, orgID, teamID int64, user string) (*github.Response, error)
	...
	RemoveTeamProjectByID(ctx context.Context, orgID, teamID, projectID int64) (*github.Response, error)
	...
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#remove-a-project-from-a-team
	RemoveTeamProjectBySlug(ctx context.Context, org, slug string, projectID int64) (*github.Response, error)
	...
	ReviewTeamProjectsByID(ctx context.Context, orgID, teamID, projectID int64) (*github.Project, *github.Response, error)

	// ReviewTeamProjectsBySlug checks whether a team, given its slug, has read, write, or admin
	// permissions for an organization project.
	//
	// GitHub API docs: https://docs.github.com/en/free-pro-team@latest/rest/reference/teams/#check-team-permissions-for-a-project
	ReviewTeamProjectsBySlug(ctx context.Context, org, slug string, projectID int64) (*github.Project, *github.Response, error)
}

// TeamsService implements the TeamsServiceInterface.
var _ TeamsServiceInterface = &github.TeamsService{}

// UsersServiceInterface defines the interface for the UsersService for easy testing.
//
...
type UsersServiceInterface interface {
	...
	IsFollowing(ctx context.Context, user, target string) (bool, *github.Response, error)
